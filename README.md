...
- 三角恒等式	
	- [和差公式](/chapters/欧几里得几何/三角恒等式/和差公式.md) 
...
- 梯度和梯度下降的方法
	- [用1个曲面的实体模型体验偏导数和梯度](/chapters/微分/用1个曲面的实体模型体验偏导数和梯度.md) | [感受学习率](/chapters/微分/感受学习率.md)
...
- 感受加减乘除的运算规律
	- [用成30度角的两个复数体会加法的计算公式](/chapters/复数分析/感受加减乘除的运算规律/用成30度角的两个复数体会加法的计算公式.md) | [用成45度角的两个复数体会乘法的计算公式](/chapters/复数分析/感受加减乘除的运算规律/用成45度角的两个复数体会乘法的计算公式.md)
	- [用成60度角的两个复数体会除法的计算公式](/chapters/复数分析/感受加减乘除的运算规律/用成60度角的两个复数体会除法的计算公式.md)

...
- 极限
	- 数列极限：[感受数列极限](/chapters/函数与解析几何/极限/感受数列极限.md) 
	- 函数极限：[感受自变量变化过程中函数值无限趋近的极限值](/chapters/函数与解析几何/极限/感受自变量变化过程中函数值无限趋近的极限值.md) 
	- 无穷大与无穷小：
	- 极限运算法则：[感受函数的和差积商的极限运算法则](/chapters/函数与解析几何/极限/感受函数的和差积商的极限运算法则.md) 
	- 极限存在法则：
	- 比较无穷小：
	- 函数的连续点与间断点：
	- 连续函数的运算与初等函数的连续性：

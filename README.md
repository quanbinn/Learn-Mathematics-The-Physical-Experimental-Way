...
- 三角恒等式	
	- [感受两个角的和与差的余弦和余弦公式](/chapters/欧几里得几何/三角恒等式/感受两个角的和与差的余弦和余弦公式.md) | [感受两个角的和与差的正切公式](/chapters/欧几里得几何/三角恒等式/感受两个角的和与差的正切公式.md) 

### 微分
- 极限和数值近似
	- [感受极限](/chapters/微分/极限和数值近似/感受极限.md) | [感受函数的和差积商的极限运算法则](/chapters/微分/极限和数值近似/感受函数的和差积商的极限运算法则.md) 
	- [感受线性近似](/chapters/微分/极限和数值近似/感受线性近似.md) 
- 导数的计算方法和运算法则

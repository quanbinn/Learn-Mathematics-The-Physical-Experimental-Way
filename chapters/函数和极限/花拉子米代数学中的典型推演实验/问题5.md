...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a1.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a2.jpg)

3. 擦去所有3cm和7cm的标记，即代表着不知道相等长度的AB, BC, CD, AD和EF的具体的长度数值，也不知道相等长度的AE和DF的具体的长度数值。

![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a3.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a4.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a5_1.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a5_2.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a6_1.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a6_2.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a6_3.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a7.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a8.jpg)

3. 擦去所有7cm和3cm的标记，即代表着不知道相等长度的AB, BC, CD, AD和EF的具体的长度数值，也不知道相等长度的AE和DF的具体的长度数值。

![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a9.jpg)

4. 假设相等长度的AB, BC, CD, AD和EF的具体的长度数值为x, 在线段AB, BC, CD, AD和EF的边上写上x。同时已经预先知道 ▭ AEFD的面积为21 cm<sup>2</sup> (即: 21个1cm<sup>2</sup>的 □ 格子)和 ▭ BCFE的面积 =  □ ABCD的面积 + ▭ ADFE的面积。即: 10×x = x×x + 21。  

![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a10.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a11_1.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a11_2.jpg)
...
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a12_1.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a12_2.jpg)
![](/images/函数和极限/花拉子米代数学中的典型推演实验/问题5/1a12_3.jpg)

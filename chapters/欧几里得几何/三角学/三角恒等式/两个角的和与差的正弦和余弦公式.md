...
6. 依据毕达哥拉斯定理的运算得出 $AB = \frac{\sqrt{2}}{2}$, $OB = \frac{\sqrt{2}}{2}$。

7. 同理得出 $BC = \frac{\sqrt{2}}{4}$, $OC = \frac{\sqrt{6}}{4}$。

8. 推演得出∠ABE = ∠BOC = 30°，∠BAE = ∠OBC = 60°。可以运算出 $AE = \frac{\sqrt{2}}{4}$, $BE = \frac{\sqrt{6}}{4}$。

9. 推演得出∠DAO = ∠AOC = 75° = ∠AOB + ∠BOC = 45° + 30°。可以运算出 $OD = sin(30°+45°)$, $DA = sin(30°+45°)$。

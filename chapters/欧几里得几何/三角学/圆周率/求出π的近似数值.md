...
$$ => \sqrt{2} < \mathop{BC}\limits^{\frown} < 2 $$

$$ => \sqrt{2} < \mathop{BC}\limits^{\frown} < 2 $$

$$ => \sqrt{2} × 4 < \mathop{BC}\limits^{\frown} × 4 < 2 × 4 $$

$$ => \frac{4\sqrt{2}}{2} < \frac{\mathop{BC}\limits^{\frown} × 4}{2} < \frac{2 × 4}{2} $$

$$ => 2\sqrt{2} < \frac{\mathop{BC}\limits^{\frown} × 4}{2} < 4 $$

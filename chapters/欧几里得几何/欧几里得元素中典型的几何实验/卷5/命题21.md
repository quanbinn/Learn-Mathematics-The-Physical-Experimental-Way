## 命题21: 如果有三个量，又有个数与之相等的另外三个量，它们两两成相同的比值，而且它们成调动比例，那么如果按照首末比例第一个量大于第三个量，那么第四个量也大于第六个量；如果第一个量等于第三个量，那么第四个量也等于第六个量；如果第一个量小于第三个量，那么第四个量也小于第六个量。

## 实验材料

## 实验步骤

![](/images/欧几里得几何/欧几里得元素中典型的几何实验/卷5/命题21/1a1.jpg)

...
## 参照试验[同余和不同余](https://github.com/quanbinn/Learn-Mathematics-The-Physical-Experimental-Way/blob/master/chapters/数论/高斯算术研究中的典型推演实验/基本概念/同余和不同余.md)，**上面用来量尽其他数量的特定数量（例如5）被称作模。模必须是正整数。**
